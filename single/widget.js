(function () {
  ...
  if (!document.querySelector("style[data-splshy-single]")) {
    ...
    style.textContent = [
      ...
      ".srv-label{color:#fff;font-size:16px;font-weight:500;line-height:1.35;letter-spacing:.01em;text-shadow:0 1px 4px rgba(0,0,0,.4);padding-left:4px;margin-right:20px}",
